		...
		<!-- /header -->
			<div id="content">
				<div class="subcontent">﻿
					<div id="contact" >
					<?php if($envoi) { ?>
<!-- tags:11-->					<h2 id="contact-title">Nous vous remercions pour votre intérêt et vous contactons au plus vite.<br/>A très bientôt.</h2>
						<?php } else { ?>
<!-- tags:12-->					<h2 id="contact-title">Malheureusement votre message n'a pas pu nous être acheminé.<br/>Vous pouvez nous contacter directement à l'adresse suivante:<br/><a href="mailto:contact@msabusiness.de">contact@msabusiness.de</a></h2>
						<?php } ?>	
					</div>
				</div>
			</div>
