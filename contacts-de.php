...
<!-- tags:7-->						<a href="contacts-fr.html" class="linkheader" title="">
			...
			<div id="logo">
<!-- tags:8-->				<a class="linklogo" href="home-de.html" title="msabusiness.de - Home">
					<p id="logo">
			...
			<div id="main-menu">
				<ul id="header_nav">
<!-- tags:9-->					<li><a href="home-de.html" class="linkheader">Home</a></li>
<!-- tags:10-->					<li><a href="contacts-de.html" class="linkheader">Kontaktieren Sie uns</a></li>
				</ul>
			</div>
		</div>
		<!-- /header -->
			<div id="content">
				<div class="subcontent">﻿
					<div id="contact" >
					<?php if($envoi) { ?>
<!-- tags:11-->					<h2 id="contact-title">Wir danken Ihnen für Ihre Interesse and kontaktiren Ihnen sobald wie möglich.<br/>Bis bald.</h2>
						<?php } else { ?>
<!-- tags:12-->					<h2 id="contact-title">Leider haben wir Ihre Nachricht nicht erhalten. Sie können uns direkt per E-Mail durch diese Adresse kontaktiern:<br/><a href="mailto:contact@msabusiness.de">contact@msabusiness.de</a></h2>
						<?php } ?>	
					</div>
				</div>
			</div>
